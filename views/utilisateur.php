  ...
  <main id="main" class="main">
        <div class="row " >
            ...
            <div class="col-120 bg-dark position-fixed m-auto p-3">
                ...
                <h2 class=" text-danger">Utilisateur</h2>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6  col-sm-6 p-3">
                                            ...
                                            <select name="fonction" id="fonction" class="form-select">
                                                <?php if(isset($_GET['id'])){ ?>
                                                    ...
                                                    <option <?php if($modData['fonction']=="patron"){ ?> Selected <?php } ?> value="patron">patron</option>
                                ...
                                <h4 class="p-3 ">Liste des utilisateurs</h4>
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                            ...
                                            <th scope="row"><a href="../admin/assets/img/profils/<?= $data['photo'] ?>"><img src="../admin/assets/img/profils/<?= $data['photo'] ?>" alt="" width=40></a></th>
                                            <td><?=$data['nom']." ".$data['postnom']." ".$data['prenom'] ?></td>
                                            <td><?=$data['username'] ?></td>
                                            <td><?=$data['password']?></td>
                                            <td><?=$data['fonction']?></td>
                                            <td>
                                                <a href="utilisateur.php?id=<?=$data['id']?>" class="btn btn-danger btn-sm "><i
