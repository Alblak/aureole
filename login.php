            ...
            <div class="background-dark ">
                <div class="devise">
                    <center><div class="round-photo-container">
                        <img src="admin/assets/img/log.png" alt="Photo ronde" class="round-photo">
                    </div></center>
                    <p>"the techno of the brain"</p>
                </div>
            </div>
        </div>
        <div class="right-side">
        <form class="row g-3 needs-validation" method="POST" action="models/login_traitement.php">
                <h2>Connexion</h2>
                ...
                <button name="valider" id="valider" class="btn btn-danger danger" type="submit">Se connecter</button>
